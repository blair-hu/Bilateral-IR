function [start_err,start_ss_err,start_t_err,chan_include,chan_selected,error_include,error_ss_include,error_t_include] = SFS_BHH(filename,chanPrev,checkChan,totChan)
% Function: Perform feature extraction for all modalities

% Input: filename (ABXXX_toclassify.mat), channels already included, candidate channels, total channels to select  
